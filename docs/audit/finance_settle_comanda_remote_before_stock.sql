-- Read-only reference captured from the linked Supabase project on 2026-06-09.
-- Purpose: rollback/review baseline before adding auditable stock settlement.
-- Remote signature:
--   public.finance_settle_comanda(uuid,uuid,text,numeric,timestamp with time zone,text,text,text)
