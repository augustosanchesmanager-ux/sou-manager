...
- [ ] **Bloco de Hardening da Homologação / Vercel (D-HOM-10/11):** origem oficial única ✅ · destino do legado `sou-manager` — git link desconectado ✅ (destino final = PO) · **ETAPA B auth/tenant ⏳ ADIADA (aguarda conta de homologação no tenant Sanchez Barber)** · preview oficial `68acda4` ✅ · re-teste de Comissões · testes H-1..H-7 · registro de achados P0/P1/P2 · fechamento H-1…H-8
