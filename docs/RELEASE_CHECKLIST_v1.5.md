...
- [ ] H-3 Chef Club (adesão, benefícios, regras de plano, reflexos financeiros, permissões) — **em execução (2026-08-13): H3-4 consumo de créditos validado via SQL no banco real — sem `42703`, idempotência OK, 2 bugs corrigidos na RPC `bulk_close_comandas_with_credits` (evidência: `docs/audit/H3_CHEF_CLUB_CREDITS_VALIDATION.md`); pendentes H3-1/H3-2/H3-3/H3-5/H3-6**
