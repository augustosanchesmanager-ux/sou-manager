 ...
 *
 * 6.0.5.3 gate de plano: exibida pelo <FeatureGuard> quando `can(feature)` é
 * falso (plano do tenant não inclui a flag). Nunca um 403 genérico — sempre
 * orienta o upgrade (D-6.0.5.3-5).
 */
...
const FeatureUnavailablePage: React.FC<{ feature: FeatureKey }> = ({ feature }) => {
