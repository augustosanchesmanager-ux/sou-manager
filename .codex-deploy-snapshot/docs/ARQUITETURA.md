# Arquitetura do Sistema: SMG - Barber

O **SMG - Barber** é uma plataforma moderna de gestão para barbearias e centros de estética, construída com uma arquitetura focada em performance, escalabilidade e experiência do usuário (UX).
