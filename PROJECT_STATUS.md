...
6.0.5  Feature Flags      ████████████████████░░  70%  ✅ 6.0.5.1 + 6.0.5.2 CERTIFICADAS (smoke 10/10; deploy deferido) + 6.0.5.3 implementada (unit 847/847, smoke 10/10) + 6.0.5.4 implementada (unit 874/874, migration T1–T7 OK; flow14 E2E adiado p/ janela única — decisão PO) + 6.0.5.5 ⏳ PLANNED (entry audit + gate Schema Freeze Candidate submetidos — ver `PHASE_6_0_5_5_ENTRY_AUDIT.md`)
...
Última auditoria: 07/08/2026 (6.0.5.5 — entry audit submetida com gate "Schema Freeze Candidate"; 6.0.6 — entry audit documental criada; ambas PLANNED)
```
